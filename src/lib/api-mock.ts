import { DIAGNOSIS_RESULTS, REPORT_STATUSES } from "./constants";
...
export const mockApi = {
  ...
  uploadXray: async (
    ...
    setTimeout(() => {
      ...
      if (reportIndex !== -1) {
        const randomDiagnosis = DIAGNOSIS_RESULTS[Math.floor(Math.random() * DIAGNOSIS_RESULTS.length)];
        mockReportsDB[reportIndex] = {
          ...mockReportsDB[reportIndex],
          status: "COMPLETED",
          diagnosis: randomDiagnosis,
          confidence: Math.random() * 100,
          findings: `Mock findings for ${randomDiagnosis}. This would be generated by the ML model in production.`,
